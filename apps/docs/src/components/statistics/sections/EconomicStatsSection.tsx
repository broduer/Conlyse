...
export default function EconomicStatsSection({ global: g, countries, timeseries }: Props) {
  ...
  if (!prodData || Object.keys(prodData).length === 0) {
    return (
      <section id="section-economic" className={styles.section}>
  ...
  return (
    <section id="section-economic" className={styles.section}>
      ...
      <div className={styles.grid}>
        <div id="chart-economic-total" className={styles.chartCard}>
        ...
        <div id="chart-economic-money" className={styles.chartCard}>
        ...
        <div id="chart-economic-rate" className={styles.chartCard}>
        ...
        <div id="chart-economic-timeseries" className={styles.chartCard} style={{ gridColumn: '1 / -1' }}>
