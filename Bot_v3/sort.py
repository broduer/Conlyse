...
def sort(game_id, data, data_requests):
    ...
    if len(states) > 5:
        ...
        sorted_data["static_province"] = sort_static_provinces(data_requests["1"]["data"],
    ...
    if "1" in states:
        ...
        sorted_data["countries"] = sort_countries(data)
        sorted_data["teams"] = sort_teams(data)
    ...
    if "4" in states:
        ...
        sorted_data["trades"] = sort_trades(data)
    ...
    for province_2 in data_2_locations:
        ...
        if province_2["@c"] == "p":
            ...
            provinces[province_1["id"]] = dict({
                ...
                "map_id": int(data_2_old["result"]["states"]["12"]["mapID"]),
                "game_id": game_id,
                "upgrades": upgrades,
            })
    return provinces
